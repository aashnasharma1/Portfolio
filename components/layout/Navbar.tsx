    ...
    >
      <nav
        ...
        style={{
          ...
          border:         scrolled ? "1px solid rgba(15,13,12,0.08)" : "1px solid transparent",
      ...
      >
        ...
        >
          <span className="w-1.5 h-1.5 rounded-full" style={{ background: "rgba(255,248,249,0.5)" }} />
          Hire Me
        </motion.a>
      </nav>
    </motion.header>
