...
export default function Experience() {
  return (
    <section id="experience" className="section-pad" style={{ background: "#ffffff" }}>
      <div className="inner">
        {/* Header */}
    ...
    >
      ...
      <div>
        <p
          ...
          style={{ fontSize: "clamp(14px, 1.3vw, 16px)", color: "#0f0d0c", lineHeight: 1.3 }}
        >
          {role.company}
        </p>
        <p style={{ fontSize: 13, color: "#e91e8c", marginTop: 4 }}>{role.role}</p>
      </div>

      {/* Middle: description + tags */}
      <div>
        <p style={{ fontSize: "clamp(13px, 1.1vw, 14px)", color: "#5a5450", lineHeight: 1.75 }}>
          {role.desc}
        </p>
